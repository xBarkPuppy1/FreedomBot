...
public class Command_cleanup implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String string, String[] args) {
        ...
        //        }
        //    }
        //    sender.sendMessage(BotUtil.BOTPREFIX + "You have used the cleanup command.");
            sender.sendMessage(BotUtil.BOTPREFIX + "This command is currently being fixed.");
        } else {
            sender.sendMessage(BotUtil.NO_PERMISSION);
            plugin.getLogger().log(Level.WARNING, "Player {0} tried to use the command /cleanup.", sender.getName());
            return true;
        }
